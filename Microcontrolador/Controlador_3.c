...
void main()
{
   ...
   while (true)
   {
      ...
      if (kbhit())
      {
         //Captura o caractere digitado pela porta serial
         //Chama a funcao que faz o tratamento
         mem_pos=verifica_serial(getc(),mem_pos);
      }
...
/*
      // Irrigação nebulizacao para estaquia
...
*/
   ...
   // Irrigação de maior volume (2x ao dia nos dias frios)
   if (((Temp_16<300)) && ((int)RH>60)){     //Se a Temp<30 e humid>60
